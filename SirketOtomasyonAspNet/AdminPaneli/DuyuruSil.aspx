 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DuyuruSil.aspx.cs" Inherits="SirketOtomasyonAspNet.AdminPaneli.DuyuruSil" %>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <asp:Button ID="btnSil" CssClass="btn btn-warning" runat="server" Text="Sil" OnClick="btnSil_Click"  />
